  ...
  static get defaultOptions() {
    ...
    return foundry.utils.mergeObject(
      super.defaultOptions,
      {
        ...
        template: "systems/girl-by-moonlight/templates/sav-clock-sheet.html",
        width: 360,
        height: 550,
...
export default {
  ...
  if( !a?.flags['girl-by-moonlight']?.clocks ) {
    return false;
  }
  ...
  html.find("div.left").append(button1HTML).click(async (event) => {
    ...
    const oldClock = new SaVClock(a.flags['girl-by-moonlight']?.clocks);
    let newClock;
