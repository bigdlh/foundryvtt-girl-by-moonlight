...
function _migrateActor(actor) {
  ...
  // Migrate Trans to Array
  if (typeof actor.system.transcendence === 'undefined') {
    updateData[`system.transcendence.value`] = actor.system.transcendence;
    updateData[`system.transcendence.max`] = 4;
    updateData[`system.transcendence.max_default`] = 4;
    updateData[`system.transcendence.name_default`] = "BITD.Transcendence";
    updateData[`system.transcendence.name`] = "BITD.Transcendence";
  }

  // Migrate Friend to Array
  if (typeof item.system.friend === 'undefined') {
    updateData[`system.friend.list`] = item.system.friend.list;
    updateData[`system.friend.value`] = item.system.friend;
    updateData[`system.friend.max`] = 6;
    updateData[`system.friend.max_default`] = 6;
    updateData[`system.friend.name_default`] = "BITD.Friend";
    updateData[`system.friend.name`] = "BITD.Friend";
  }
